function [BscanCpx,BscanCpxNorm, band1spatial, band2spatial, compoundImg, diffImg] =...
    calcSpectral(k, apodization, interf, ascanAve, dispComp, params, frames2Avg, saveAlgoDataPath)
%%This function is run the DualBand method
%
%USAGE:
% [BscanCpx,BscanCpxNorm, band1spatial, band2spatial, compoundImg, diffImg] =...
   % calcSpectral(k, apodization, interf, ascanAve, dispComp, params, frames2Avg, saveAlgoDataPath)
%
% INPUTS:
%   - k - chirp vector 
...
%Create zero variables to save memory
