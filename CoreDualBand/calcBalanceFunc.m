...
%%This function performs band balancing and runs the main balance function
%
%USAGE:
% [balanceParams, h] = calcBalanceFunc(band1spatial,band2spatial,speckVar,balanceParams)
%
% INPUTS:
%   - band1spatial - intensity values of band1
%   - band2spatial - intensity values of band2
%   - speckVar - Speckle Variance image
%   - balanceParams - balance strcuture (balanceFunc)  
% OUTPUTS: 
%   - balanceParams - balance strcuture (balanceFunc) updated  
